...
if __name__ == "__main__":
    ...
    parser.add_argument('--images_folder_path', type=str, default="../vine/512/DET_INVERSION_1K")
    parser.add_argument('--total_output_path', type=str, default="/home/shilin1/projs/datasets/edited_image/vine/DET_INVERSION_1K")
